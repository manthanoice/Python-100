...
class InternetSpeedTwitterBot():
    ...
    def tweet_at_provider(self):
        ...
        if float(self.download_speed) > EXPECTED_DOWNLOAD_SPEED and float(self.upload_speed) > EXPECTED_UPLOAD_SPEED:
            ...
            self.message = 'Hey internet service provider, why my internet speed currently is {} down and {} up when we had deal of having {} down and {} up'.format(self.download_speed, self.upload_speed, EXPECTED_DOWNLOAD_SPEED, EXPECTED_UPLOAD_SPEED)
